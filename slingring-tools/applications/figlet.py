...
########################################################
from system.command import get_command_output


def get_ascii_art_text(text, font='slant'):
    return get_command_output(['figlet', '-f', font, text], 'create-ascii-art-text-phase').rstrip('\n ')
